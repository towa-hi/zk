...
import { MineGameGame } from './games/mine-game/MineGameGame';

const GAME_ID = 'mine-game';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'Mine Game';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_MINE_GAME_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
